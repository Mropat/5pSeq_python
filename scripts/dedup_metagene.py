...
#        if transcript.get_sequence(fasta_dict)[50:53] == "ATG":
            ...
            count_vectors_term.append(value_array[1:100])
            count_vectors.append(value_array[-99:])
            value_array = transcript.get_counts(alignments_dedup)
            count_vectors_dedup_term.append(value_array[1:100])
...
plot_results_start(metagene, metagene_dedup)
plot_results_stop(metagene_term, metagene_dedup_term)